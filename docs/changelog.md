...
- 重新核验官网 6 页 Academic Staff 列表和 58 个教师个人页，在 `fds_mentors.md` 补充教育背景、授课课程、官网项目/成果和明确招募说明；官网未写明时不使用外部资料猜测补全。
- 本次官网字段覆盖：教育背景 57/58、授课课程 35/58、项目或成果 51/58、明确招募说明 2/58；其余记录为“官网未提供”或“官网未公开招募说明”。
