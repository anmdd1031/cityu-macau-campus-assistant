...
| FDS 近期论文证据 | [fds_faculty_publications.md](../skills/cityu-macau-campus-assistant/references/fds_faculty_publications.md) | 已完成 | 47 名教师、185 篇 2023 年以来高置信论文、DOI、作者位置和贡献证据等级 |
| FDS 导师匹配规则 | [fds_mentor_recommendation.md](../skills/cityu-macau-campus-assistant/references/fds_mentor_recommendation.md) | 已完成 | 输入追问、来源优先级、贡献证据 A-E、多篇聚合、技术参与与指导能力边界 |
...
| FDS 导师推荐、教师研究方向、近期论文、代表论文、作者贡献或谁研究某个主题 | `fds_mentor_recommendation.md` + `fds_faculty.md` + `fds_faculty_publications.md` |
