...
description: 当用户询问澳门城市大学、澳城大或 City University of Macau 的招生、费用、注册、D 签注、逗留许可、宿舍、校园服务、校内餐饮、恶劣天气安排，或数据科学学院、商学院、金融学院、大健康学院、教育学院、法学院、荣誉班课程、学分、转专业、导师、学术成果、论文发表与毕业要求时使用。
---
...
- 用户问“各学院学费是多少”“所有学院收费是多少”时，先读取 `references/freshman.md` 的学费和费用章节；如问题指定 FDS、FOB、FOF、FH、FE、FL 或荣誉班，再追加对应 reference。若知识库只覆盖部分学院，应列出已覆盖范围，并说明未覆盖学院需查招生事务处或财务部最新收费表。
