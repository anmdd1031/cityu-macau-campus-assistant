...
description: 当用户询问澳门城市大学、澳城大或 City University of Macau 的招生、费用、注册、D 签注、逗留许可、宿舍、校园服务、校内餐饮、恶劣天气安排，或数据科学学院教师、导师推荐、研究方向、教师主页，以及各学院课程、学分、转专业、导师、学术成果、论文发表与毕业要求时使用。
---
...
- 数据科学学院（FDS）本硕博课程、学分、转专业、师资、导师方向匹配、教师主页、资格考试、学术成果和毕业要求。
...
| FDS 导师推荐、找导师、研究方向、教师方向、师资、教师主页、硕导、博导，或询问谁研究人工智能、大模型、数据科学、隐私计算、联邦学习、网络安全、区块链、计算机视觉、机器人等主题 | `references/fds_faculty.md` |
...
3. 按“官网明确主要方向、多关键词匹配、简介或成果补充、间接关联”判断相关度，不输出无法证实的百分比。
...
6. 使用“教师、导师资格、匹配研究方向、相关依据、官方主页”表格回答。官网未明确导师资格者只能称为“方向相关教师”。
