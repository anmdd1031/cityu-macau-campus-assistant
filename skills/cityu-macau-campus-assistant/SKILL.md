...
description: 当用户询问澳门城市大学、澳城大或 City University of Macau 的招生、费用、注册、D 签注、逗留许可、宿舍、校园服务、校内餐饮、恶劣天气安排，或数据科学学院教师、导师推荐、研究方向、近期论文、官方邮箱、教师主页，以及各学院课程、学分、转专业、导师、学术成果、论文发表与毕业要求时使用。
---
...
- 数据科学学院（FDS）本硕博课程、学分、转专业、师资、导师方向匹配、近期论文、校内工作邮箱、教师主页、资格考试、学术成果和毕业要求。
...
| FDS 导师推荐、找导师、研究方向、近期论文、代表论文、论文主题，或询问谁研究人工智能、大模型、数据科学、隐私计算、联邦学习、网络安全、区块链、计算机视觉、机器人等主题 | `references/fds_faculty.md` + `references/fds_faculty_publications.md` |
...
3. 按“官网明确主要方向、多关键词匹配、近期论文重复佐证、简介或成果补充、间接关联”判断相关度。官网方向优先于论文推断；不得把论文数量或单篇标题直接当成研究占比。
...
每条导师或论文资料应尽量记录：来源链接、来源等级、核验日期、资料适用年份或时间范围、事实类型（官网明确/论文证据/根据简介或成果推断）和待复核说明。招生状态、接收意愿、导师职务、研究方向和公开邮箱可能变化；没有带日期的官方招生信息时，不得暗示当前有名额或正在招生。资料冲突时，优先采用更高等级且更新日期更近的来源。
