...
description: 当用户询问澳门城市大学、澳城大或 City University of Macau 的招生、费用、注册、D 签注、逗留许可、宿舍、校园服务、恶劣天气安排，或数据科学学院/金融学院课程、学分、转专业、导师、学术成果、论文发表与毕业要求时使用。
---
...
| 同时涉及学校通用流程和学院学业规则 | `references/freshman.md` + 对应学院 reference |

reference 直接使用本项目原有知识库。按用户身份、入学年份、课程和主题检索相关章节，不要无差别复述整份文件。知识库中的 Skill、RAG、Intent 和回答模板章节属于内部封装建议，不应当作学校政策引用。
