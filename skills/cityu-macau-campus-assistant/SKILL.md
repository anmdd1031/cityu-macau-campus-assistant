...
description: 当用户询问澳门城市大学、澳城大或 City University of Macau 的招生、费用、注册、D 签注、逗留许可、宿舍、校园服务、校内餐饮、恶劣天气安排，或数据科学学院教师、导师推荐、研究方向、官方邮箱、教师主页，以及各学院课程、学分、转专业、导师、学术成果、论文发表与毕业要求时使用。
---
...
8. `references/mentors/fds_papers.md` 当前暂时停用，不得读取、引用或将其中内容用于导师推荐；导师匹配只采用官网方向、导师资格和官网科研证据。
9. 需要解释导师在论文中负责哪一部分时，只能读取 `references/mentors/fds_official_evidence.md` 中官网已公开的内容；没有明确贡献声明时，只能说“现有官网资料无法确认具体负责模块”。
